...
const consumerKey = "ck_fc5c104051c6f9f3cfbc4fe1d7ffb0663acc5301";
const consumerSecret = "cs_93685e780dec853afb2ccfd49c5ae3a56924ff5e";
const url = "https://ykz.68d.myftpupload.com/";
...
export default {
   ...
   */
  WooCommerce: {
    url: "https://ykz.68d.myftpupload.com/",
    consumerKey,
    consumerSecret,
  },
  ...
  HomeCategories: [
    {
      category: 55,
      image: require("@images/categories_icon/ic_profile.png"),
      colors: ["#4facfe", "#00f2fe"],
      label: "Profile",
    },
    {
      category: 21,
      image: require("@images/categories_icon/ic_none.png"),
      // colors: ["#43e97b", "#38f9d7"],
      colors: ["#1C00ff00", "#38f9d7"],
      label: "",
    },
    {
      category: 208,
      ...
      colors: ["#1C00ff00", "#fee140"],
      label: "",
    },
    {
      category: 26,
      image: require("@images/categories_icon/ic_speaker.png"),
  ...
  showStatusBar: true,
  LogoImage: require("@images/iMaker_logo_Horizontal-01.jpg"),
  LogoWithText: require("@images/iMaker_logo_Horizontal-01.jpg"),
  ...
  HomeCaching: {
    url: `https://${url}/wp-json/wc/v2/flutter/cache?consumer_key=${consumerKey}&consumer_secret=${consumerSecret}`, // can change url to load another server
