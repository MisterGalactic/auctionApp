...
const QrCodeStack = withTheme(({ theme }) => {
  return (
    <QrCodeNavigator.Navigator>
      <QrCodeNavigator.Screen
        name={ROUTER.USER_PROFILE}
...
const MainNavigator = () => {
  return (
    <MainBottomTab.Navigator
      ...
      />
      <MainBottomTab.Screen
        name={ROUTER.QR_STACK}
        component={QrCodeScreen}
        options={{
          tabBarIcon: ({ tintColor }) => (
            <TabBarIcon
              css={{ width: 85, height: 85, bottom: 30 }}
              icon={Images.IconLogo}
              tintColor={tintColor}
            />
          ),
        }}
